...
abstract class $LocationModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? address, String? city, String? country});
}
...
class _$_LocationModel implements _LocationModel {
  const _$_LocationModel({this.address, this.city, this.country});
  ...
  @override
  String toString() {
    return 'LocationModel(address: $address, city: $city, country: $country)';
  }
